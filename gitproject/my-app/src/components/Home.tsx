        ...
        className="login-space">
			<div className="login">
				...
				<div className="group">
					...
					<label htmlFor="check"><span 
                    className="icon"></span> Keep me Signed in</label>
				</div>
				<div className="group">
					<input type="submit" 
			...
			<div className="sign-up-form">
				...
				<div className="group">
                    ...
                    className="input" data-type="password" placeholder="Create your password"/>
				</div>
				<div className="group">
